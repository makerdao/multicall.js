...
var properties_5 = properties.shallowCopy;
var properties_6 = properties.deepCopy;
var properties_7 = properties.inheritable;
...
var AGGREGATE_SELECTOR = '0x9af53fc6';
...
function encodeParameter(type, val) {
...
function formatInputBytes(rawData) {
  var bytesLength = padLeft((rawData.length / 2).toString(16), 64);
  var location = padLeft('20', 64);
  var result = location + bytesLength + rawData;
...
function _ethCall() {
  ...
  /*#__PURE__*/
  regenerator.mark(function _callee(rawData, config) {
    var abiEncodedData, rawResponse, content;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            abiEncodedData = formatInputBytes(strip0x(rawData));
            _context.next = 3;
            return fetch(config.rpcNode, {
              method: 'POST',
              headers: {
          ...
          case 6:
            ...
            return _context.abrupt("return", stripWords(content.result, 2));
...
var presets = {
	...
	mainnet: {
		...
		helperContractAddress: "0xfd536f5bc03ed27a240b3f80da898c9e4c33e7b1"
	}
};
var multicallContractAbi = [
	{
		constant: true,
		inputs: [
			{
...
var config = {
	presets: presets,
	multicallContractAbi: multicallContractAbi
};
  ...
  createClass(MultiCall, [{
    ...
    value: function _makeMulticallData(calls, keepAsArray) {
      ...
      var components = calls.reduce(function (acc, _ref2) {
        ...
        if (!args) args = [];
        return acc.concat([encodeParameter('address', to), padLeft(returnsLength, 64), padLeft('40', 64), padLeft((args.length * 32 + 4).toString(16), 64), '0x' + sha3_1(method).substr(0, 8), encodeParameters(args.map(function (a) {
          return a[1];
        }), args.map(function (a) {
          return a[0];
        }))].map(function (v) {
          return v ? strip0x(v) : null;
        }).filter(function (v) {
          return v;
        }));
      }, []);
    ...
    key: "aggregate",
    value: function () {
      var _aggregate = asyncToGenerator(
      /*#__PURE__*/
      regenerator.mark(function _callee(calls) {
        var calldata, result, blockNumber, typeArray, retNameArray, parsedVals, retObj, i;
        return regenerator.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                calldata = this._makeMulticallData(calls, false);
                _context.next = 3;
                return ethCall(calldata, this.config);

              case 3:
                result = _context.sent;
                blockNumber = decodeParameter('uint256', result.slice(0, 66))[0].toString();
                typeArray = calls.map(function (ele) {
                ...
                for (i = 0; i < retNameArray.length; i++) {
